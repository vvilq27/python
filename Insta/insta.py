...
with smart_run(session):
    ...
    session.unfollow_users(amount=50, InstapyFollowed=(True, "nonfollowers"),
                       style="FIFO",
                       unfollow_after=2 * 60 * 60, sleep_delay=61)

    session.follow_by_tags(['polskadziewczyna', 'warszawa'], amount=150)
    ...
    session.follow_by_tags(['szosa','cyclist', 'kolarstwo'], amount=100)
    ...
    # session.unfollow_users(amount=50, InstapyFollowed=(True, "nonfollowers"),
    #                        style="FIFO",
    #                        unfollow_after=12 * 60 * 60, sleep_delay=61)
